...
<body>
	...
	<pre>
		JSP EL 형식 사용해서 자바 코드를 최소화하고 데이터를 쉽게 출력하거나 조작할 수 있음
	...
	문법 : $ { } 사용해서 값을 출력
	단점 : 반복문이나 조건문 같은 처리가 불가능
	
	JSTL (Java server pages Standard Tag Library)
	목적 : JSTL JSP 페이지에서 반복, 조건문, 데이터 포맷팅, 데이터베이스 접근과 같은 작업을 수행할 때 사용
	...
	//username 변수명 안에 홍길동 이라는 이름 저장, 저장된 이름을 다른 곳에서 사용
	request.setAttribute("userage", 20);
	//userage 변수명 안에 20 이라는 숫자를 저장하고 다른 곳에서 숫자를 사용
	%>
	...
	// servlet springboot 사용하지 않을 때 사용하는 방법
	// springboot 사용해서 controller로 넘겨줄 때는 사용 빈도 낮음
